...
def parse_args():
    ...
    # General arguments
    parser.add_argument('-projd1','--w-projd1', default='0', type=float, metavar='HP', help='weight of project direction loss')
    parser.add_argument('-projl1','--w-projl1', default='0', type=float, metavar='HP', help='weight fo project length loss')
    parser.add_argument('-projd2','--w-projd2', default='0', type=float, metavar='HP', help='weight of project direction loss')
    parser.add_argument('-projl2','--w-projl2', default='0', type=float, metavar='HP', help='weight fo project length loss')
    parser.add_argument('-gpu', '--gpu-use', default='0,1', type=str, metavar='GPU', help='gpu to use')
    ...
    parser.add_argument('-bi', '--boneindex', default='16,15,15,14,13,12,12,11,10,9,9,8,11,8,14,8,8,7,7,0,3,2,2,1,6,5,5,4,1,0,4,0', type=str, metavar='LIST', help='bone index (each two indexs correspond to the two joints a bone)')
    ...
    parser.add_argument('-arc', '--architecture', default='3,3', type=str, metavar='LAYERS', help='filter widths separated by comma')
